...
var invoices_invoice_2_component_1 = require("./invoices-invoice-2.component");
...
var routes = [
    {
        ...
        "children": [
            {
                "path": "",
                "component": invoices_invoice_2_component_1.InvoicesInvoice2Component
            }
        ]
    }
];
    ...
    InvoicesInvoice2Module = __decorate([
        core_1.NgModule({
            imports: [
                ...
                invoices_invoice_2_component_1.InvoicesInvoice2Component
            ]
        })
    ], InvoicesInvoice2Module);
    return InvoicesInvoice2Module;
}());
exports.InvoicesInvoice2Module = InvoicesInvoice2Module;
